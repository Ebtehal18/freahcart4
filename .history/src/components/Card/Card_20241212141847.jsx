...
<span onClick={()=>handelAddToWish(recentPro.id)} className='group-hover:opacity-100 opacity-0 w-9 h-9 text-white flex justify-center items-center rounded-full absolute top-3 end-3 transition-all duration-500 cursor-pointer  ' >
{isAddedToWish ? (
